...
Наш сервис способен помочь в выборе одежды по изображению и текстовому промту. Он представляет из себя телеграм бота, который по совместительству является вашим персональным шоппинг ассистентом. Одежда, предлагаемая пользователю отсортирована по возрасту, гендеру, цвету (подходящий к той одежде, в которой человек находится на фото по цветовой гамме) и по ценовому потолку (если указано).
